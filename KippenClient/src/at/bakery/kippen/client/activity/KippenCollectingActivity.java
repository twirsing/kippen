...
public class KippenCollectingActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// orientation field
		// INACTIVE orientSense = senseMan.getDefaultSensor(Sensor.TYPE_ROTATION_VECTOR);
	...
	protected void onResume() {
		...
		// INACTIVE registerReceiver(wifiReceiver, new IntentFilter(WifiManager.SCAN_RESULTS_AVAILABLE_ACTION));
		// INACTIVE wifiMan.startScan();

		// INACTIVE registerReceiver(batteryReceiver, new IntentFilter(Intent.ACTION_BATTERY_CHANGED));
	}
